      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('supervisor.painel')}}">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('supervisor.pendentes')}}">Pendentes</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('supervisor.aprovadas')}}">Aprovadas</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('supervisor.relatorios.index')}}">
