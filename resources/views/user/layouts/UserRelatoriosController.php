...
class UserRelatoriosController extends Controller
{
    ...
    if ($user) {
        ...
        $sol_entradas = Solicitacoes::where('regras', 'entrada')->where('user_id', $user->id)->latest('id')->get();
        $sol_saidas = Solicitacoes::where('regras', 'saida')->where('user_id', $user->id)->latest('id')->get();
    ...
    public function gerarPdf($id)
    {
        ...
        if ($user) {
            ...
            $sol_entradas = Solicitacoes::where('regras', 'entrada')->where('user_id', $user->id)->get();
            $sol_saidas = Solicitacoes::where('regras', 'saida')->where('user_id', $user->id)->get();
