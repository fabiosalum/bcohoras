...
<div>
    <div>
    <form action="{{route('user.relatorios.pdf', $user->id)}}" method="GET">
        @csrf
        <button type="submit" class="btn btn-primary mt-2 mt-xl-0" style="float: right">Gerar PDF</button>
    </form>
    </div>
    <a href="{{route('user.relatorios.index')}}" class="btn btn-secondary mt-2 mr-2 mt-xl-0" style="float:right">Voltar</a>
</div>
