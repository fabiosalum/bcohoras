...
class SupervisorRelatoriosController extends Controller
{
    public function index()
    {
        ...
        return view ('supervisor.relatorios.index', compact('users', 'sol_entradas', 'sol_saidas'));
    ...
    if ($user) {
        ...
        return view ('supervisor.relatorios.buscar', compact('user', 'sol_entradas', 'sol_saidas', 'totalSolicitacoes_entradasFormatado', 'totalSolicitacoes_saidasFormatado', 'formatoDiferenca'));
